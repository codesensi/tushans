...
const newPath = "./tushans/index.php"
const oldPath = "./tushans/index.html"
const assetsPath = "/templates/tushans"
...
$("head").append('&lt;?php echo $site[\'custom_header\']; ?&gt;')
$("head").append(`<link rel='icon' href='${assetsPath}/favicon.ico' />`)
let result = $.html();
//转义php标签为正常标签
...
fs.copyFileSync(path.resolve("info.json"), path.resolve("./tushans/info.json")) //将配置移动到静态目录